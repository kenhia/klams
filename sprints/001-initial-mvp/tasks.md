...
**Input**: Design documents in [`/sprints/001-initial-mvp/`](.)
...
| SC-007 | Cold checkout build (service + viewport cross-build) using docs alone | PASS | `docs/setup.md`, `docs/architecture.md`, `README.md "Running the MVP"`, and `sprints/001-initial-mvp/quickstart.md` together cover the full build path. |
