...
- **FR-016**: Restore MUST be exercised once during this sprint
  ...
  `sprints/006-maintenance-and-backups/quickstart.md` as part of
  the acceptance gate.
