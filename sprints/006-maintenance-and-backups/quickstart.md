...
- [X] `just gate` green.
- [X] Sprint-005 deferred T055/T056 benchmarks now have a >=1k-fact fixture (from R-009) and can be re-evaluated. (Pointer added to `sprints/005-advanced-retrieval/tasks.md`; bench harness deferred to a follow-up sprint.)
