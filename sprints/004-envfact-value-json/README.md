...
[sprints/planning/envfact-schema-analysis.md](../planning/envfact-schema-analysis.md).
...
5. Update handoff doc
   `sprints/003-non-agentic-writes/handoff/api-contract.md`:
...
6. Mark the prior fix-forward note SUPERSEDED on the ansible-k side
   (`sprints/klams-integration/fixforward-source-and-encoding.md`) and
...
- ansible-k side: original fix-forward marked SUPERSEDED;
  `sprints/klams-integration/bug2-corrected.md` written with the
