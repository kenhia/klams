...
[sprints/planning/tokenmaster-integration/](../planning/tokenmaster-integration/README.md)
...
- **FR-021**: The spike MUST capture its findings — including a go/no-go
  ...
  the `sprints/planning/tokenmaster-integration/` folder, and MUST NOT ship
...
- **SC-010**: The TokenMaster spike produces a committed findings
  document under `sprints/planning/tokenmaster-integration/` with an
