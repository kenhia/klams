...
5. Writes `sprints/008-activity-observability/perf-baseline.md` with the numbers, the timestamp, the seed, the host hostname (for context), and the row counts observed in the store (sanity check the fixture loaded).
