...
[sprints/007-mcp-server/data-model.md §8](../007-mcp-server/data-model.md#8-state-transitions)
apply unchanged.
...
| FR-019..022 | `tools/bench/` crate, `sprints/008-activity-observability/perf-baseline.md`, `README.md` link |
