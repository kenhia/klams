...
**Input**: Design documents from `/sprints/008-activity-observability/`
...
- [X] T045 [P] [US5] Generate the initial [sprints/008-activity-observability/perf-baseline.md](./perf-baseline.md) by running `just bench-seed && just bench-run` against the test compose stack; commit the resulting markdown. Smoke-sized (500 / 2000) — full corpus rerun tracked in [sprints/planning/backlog.md](../planning/backlog.md) pending klams#26.
- [X] T046 [US5] Update [README.md](../../README.md) with a one-line link: `[Performance baseline](sprints/008-activity-observability/perf-baseline.md)`.
