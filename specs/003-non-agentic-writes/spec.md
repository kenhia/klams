...
its own `specs/` directory and run a normal speckit cycle against.
...
- Phase 1 (`specs/001-initial-mvp/`) and Phase 2
  (`specs/002-safety-and-write-ops/`) are shipped and live on `kubs0`
...
- The handoff document is delivered as a directory under
  ...
  `specs/003-non-agentic-writes/handoff/` and `cp -r`'d over; the
