...
**Input**: Feature specification from `/specs/006-maintenance-and-backups/spec.md`
...
```text
specs/006-maintenance-and-backups/
...
- **Agent context update**: `.github/copilot-instructions.md` block
  ...
  points at this plan file (`specs/006-maintenance-and-backups/plan.md`).
...
- **Plan**: [specs/006-maintenance-and-backups/plan.md](./plan.md)
