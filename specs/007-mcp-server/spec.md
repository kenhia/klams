...
**Created**: 2026-05-24
**Status**: Draft
**Input**: Phase 6 of [specs/planning/plan.md](../planning/plan.md), informed by [.scratch/author-registration.md](../../.scratch/author-registration.md) and the iteration captured in the planning conversation that preceded this spec.
